...
public abstract class BaseLazyFragment<P extends IPresenter> extends BaseFragment<P> {
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        Log.w("",getClass ().getSimpleName () + "  setUserVisibleHint   isVisibleToUser " + isVisibleToUser + ",currentVisibleState=" + currentVisibleState+",isViewCreated="+isViewCreated);
        if (rootView == null) {
            return;
        }
    ...
    public void onHiddenChanged(boolean hidden) {
        ...
        Log.w("",getClass ().getSimpleName () + "  onHiddenChanged dispatchChildVisibleState  hidden " + hidden);
        if (hidden) {
            dispatchUserVisibleHint (false);
        } else {
            dispatchUserVisibleHint (true);
    ...
    public void onResume() {
        super.onResume ();
        Log.w("",getClass ().getSimpleName () + "  isFirstVisible " + isFirstVisible + ",isHidden=" + isHidden () + ",currentVisibleState=" + currentVisibleState + ",getUserVisibleHint=" + getUserVisibleHint ());
        if (!isFirstVisible) {
    ...
    private void dispatchUserVisibleHint(boolean visible) {
        Log.w("",getClass ().getSimpleName () + "dispatchUserVisibleHint visible=" + visible + ",isParentInvisible=" + isParentInvisible () + ",currentVisibleState=" + currentVisibleState + ",currentVisibleState=" + currentVisibleState+",isFirstVisible="+isFirstVisible);
