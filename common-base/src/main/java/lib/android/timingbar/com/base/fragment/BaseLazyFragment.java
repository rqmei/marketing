...
public abstract class BaseLazyFragment<P extends IPresenter> extends BaseFragment<P> {
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        BaseLog.e (getClass ().getSimpleName () + "  setUserVisibleHint   isVisibleToUser " + isVisibleToUser + ",currentVisibleState=" + currentVisibleState+",isViewCreated="+isViewCreated);
        if (rootView == null) {
            return;
        }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        BaseLog.e (getClass ().getSimpleName () + "  onActivityCreated----");
    }
    ...
    public void onResume() {
        ...
        if (!isFirstVisible) {
            ...
            if (!isHidden () && !currentVisibleState && getUserVisibleHint ()) {
                BaseLog.e (getClass ().getSimpleName () + "onResume  onFragmentFirstVisible-----");
    ...
    private void dispatchUserVisibleHint(boolean visible) {
        BaseLog.e (getClass ().getSimpleName () + "dispatchUserVisibleHint visible=" + visible + ",isParentInvisible=" + isParentInvisible () + ",currentVisibleState=" + currentVisibleState + ",currentVisibleState=" + currentVisibleState+",isFirstVisible="+isFirstVisible);
        ...
        if (visible) {
            if (isFirstVisible) {
                BaseLog.e (getClass ().getSimpleName () + "dispatchUserVisibleHint  onFragmentFirstVisible-----");
                isFirstVisible = false;
                onFragmentFirstVisible ();
            }
            onFragmentResume ();
